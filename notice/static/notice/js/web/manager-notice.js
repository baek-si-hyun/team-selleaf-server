...
const addPaginationEvent = (pageInfo) => {
    ...
    if (pageInfo.page > 1) {
        ...
        pageCountPrev.addEventListener("click", async () => {
            await noticeService.getList(keyword, --page, createHTML.showList);
        });
    }
...
noticeService.getList(keyword, page, createHTML.showList);
...
const handleCancelClick = async () => {
    ...
    page = 1 // 페이지 1로 초기화
    await noticeService.getList(keyword, page, createHTML.showList) // 신고 목록을 다시 불러옴
}
