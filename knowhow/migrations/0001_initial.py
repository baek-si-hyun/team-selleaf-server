...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='KnowhowPlant',
            fields=[
                ('plant_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='plant.plant')),
                ('knowhow', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='knowhow.knowhow')),
            ],
            options={
